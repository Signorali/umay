                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 14, marginBottom: 4, display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      {b.encrypted && <span style={{ background: '#6366f122', color: '#818cf8', fontSize: 11, padding: '2px 8px', borderRadius: 10, fontWeight: 700 }}>🔒 ŞİFRELİ</span>}
                    </div>
      ...
      {showPurge && (
        <div style={overlayStyle}>
          <div style={{ ...modalStyle, borderColor: '#ef4444', maxWidth: 480 }}>
            <div style={{ fontSize: 18, fontWeight: 800, color: '#ef4444', marginBottom: 16 }}>🗑 Tarih Aralığında İşlem Temizle</div>
