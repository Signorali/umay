      ...
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
          ...
          <div>
            ...
            <p className="page-subtitle">🏦 {loan.lender_name} · {loan.currency}</p>
          </div>
        </div>
          ...
          <div className="modal-backdrop" onClick={() => setPayModal({ open: false })} style={{ zIndex: 110 }}>
            <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 520 }}>
              <div className="modal-header">
                ...
                <button className="btn btn-ghost btn-icon btn-sm" onClick={() => setPayModal({ open: false })}>✕</button>
              </div>
        ...
        <div className="modal-backdrop" onClick={() => setShowEarlyClose(false)} style={{ zIndex: 110 }}>
          <div className="modal modal-sm" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button className="btn btn-ghost btn-icon btn-sm" onClick={() => setShowEarlyClose(false)}>✕</button>
            </div>
            <div className="modal-body">
