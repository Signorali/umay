                ...
                <div key={m} style={{
                  ...
                  <div style={{ marginBottom: 8, display: 'flex', justifyContent: 'center' }}>
                    {locked ? (
                      ...
                      <span style={{ opacity: 0.3 }}><LockIcon size={18} /></span>
                    ) : (
                      <UnlockIcon size={18} />
                    )}
                  </div>
      ...
      {confirm && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 20, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
              {confirm.action === 'lock' ? <><LockIcon size={18} /> Dönemi Kilitle</> : <><UnlockIcon size={18} /> Dönemi Aç</>}
            </div>
