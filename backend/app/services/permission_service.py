...
class PermissionService:
    ...
    async def seed_system_permissions(
        ...
        Uses INSERT ... ON CONFLICT DO NOTHING to handle concurrent startups safely.
        """
        from sqlalchemy.dialects.postgresql import insert as pg_insert
        from app.models.permission import Permission as PermModel
        ...
        stmt = pg_insert(PermModel).values(rows).on_conflict_do_nothing(
            index_elements=["module", "action"]
        )
